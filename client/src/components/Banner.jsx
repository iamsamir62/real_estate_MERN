...
const Banner = () => {
  return (
    <section className="h-[600px] w-full flex felx-col justify-center  relative overflow-clip  mx-auto">
      ...
      <div className="absolute text-white top-0 left-0 right-0 z-10  bg-black bg-opacity-20 h-full">
        <div className="flex  h-full w-10/12 mx-auto flex-col">
          <div className=" flex flex-col items-center lg:items-start text-center lg:text-left justify-center flex-1 px-4 lg:px-0">
            ...
            <p className="max-w-[480px] mb-8">
              Find your ideal room or flat in prime locations with just a few
              clicks. Our platform offers a variety of rental options tailored
              to your needs and budget. Start your journey to comfortable living
              with us. Explore, compare, and choose your next home with ease.
            </p>
          </div>
